// Fast deployment script for Amoy testnet with high gas price
require("dotenv").config();
const { ethers } = require("hardhat");

async function main() {
  try {
    console.log("Starting high-priority deployment to Amoy testnet...");
    ...
    const ContractFactory = await ethers.getContractFactory("SovranWealthFundMinimal");
